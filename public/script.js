...
async function openModal(item) {
    ...
    const servers = [
        { name: "Zxcstream", url: `https://zxcstream.xyz/embed/${currentMediaType}/${activeItemId}&sub=id,en` },
        { name: "VidSrc XYZ", url: `https://vidsrc.xyz/embed/${currentMediaType}?tmdb=${activeItemId}&sub=id,en` },
        { name: "VidSrc ME", url: `https://vidsrc.me/embed/${currentMediaType}?tmdb=${activeItemId}&sub=id,en` },
        { name: "Embed SU", url: `https://embed.su/embed/${currentMediaType}/${activeItemId}&sub=id,en` },
        { name: "VidSrc CC", url: `https://vidsrc.cc/v2/embed/${currentMediaType}/${activeItemId}&sub=id,en` },
        { name: "MultiEmbed", url: `https://multiembed.mov/?video_id=${activeItemId}&tmdb=1${currentMediaType === 'tv' ? '&s=1&e=1' : ''}&sub=id,en` },
        { name: "AutoEmbed", url: `https://player.autoembed.cc/embed/${currentMediaType}/${activeItemId}&sub=id,en` },
        { name: "2Embed", url: `https://2embed.cc/embed/${currentMediaType}/${activeItemId}&sub=id,en` },
        { name: "MoviesAPI", url: `https://moviesapi.club/movie/${activeItemId}&sub=id,en` },
        { name: "VidSrc VIP", url: `https://vidsrc.vip/embed/${currentMediaType}/${activeItemId}&sub=id,en` },
        { name: "Anime-KKI", url: `https://anime-kki.herokuapp.com/embed/${activeItemId}&sub=id,en` },
        { name: "VidSrc NL", url: `https://player.vidsrc.nl/embed/${currentMediaType}/${activeItemId}&sub=id,en` },
        { name: "IDSrc TO", url: `https://idsrc.to/embed/${currentMediaType}/${activeItemId}&sub=id,en` },
        { name: "VidSrc ICU", url: `https://vidsrc.icu/embed/${currentMediaType}/${activeItemId}&sub=id,en` },
        { name: "Dailymotion", url: `https://www.dailymotion.com/embed/video/${activeItemId}&sub=id,en` },
        { name: "Rumble", url: `https://rumble.com/embed/${activeItemId}/&sub=id,en` },
        { name: "Ok.ru", url: `https://ok.ru/videoembed/${activeItemId}&sub=id,en` },
